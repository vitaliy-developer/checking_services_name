#!/bin/bash
# sh /home/user1/checking_services_name/checking_logs_services_2.sh >> /home/user1/checking_services_name/output_correct_error_services_2
ip=/home/user1/checking_services_name/lists/ip_list2
IFS=$'\n'
us=/home/user1/checking_services_name/lists/us
pass=/home/user1/checking_services_name/lists/pass
TIMESTAMP=`date "+%Y-%m-%d-%H-%M-%S"`
nameServc="name_our_service_2"
